/*
  ...
  Script de mantenimiento o carga de datos: Find Culprit. Se usa para revisar, migrar o sembrar informacion durante pruebas y despliegues.
  Buscar en VS Code: script find_culprit, seed, diagnostico, migracion, Render, datos prueba.
