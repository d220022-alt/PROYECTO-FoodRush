/*
  ...
  Script de mantenimiento o carga de datos: Simple User Check. Se usa para revisar, migrar o sembrar informacion durante pruebas y despliegues.
  Buscar en VS Code: script simple_user_check, seed, diagnostico, migracion, Render, datos prueba.
