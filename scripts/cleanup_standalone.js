/*
  ...
  Script de mantenimiento o carga de datos: Cleanup Standalone. Se usa para revisar, migrar o sembrar informacion durante pruebas y despliegues.
  Buscar en VS Code: script cleanup_standalone, seed, diagnostico, migracion, Render, datos prueba.
