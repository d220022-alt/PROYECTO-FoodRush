...
async function startServer() {
  try {
    ...
    app.listen(PORT, () => {
      ...
      console.log('   POST /api/productos        - Crear producto protegido');
      console.log('   GET  /api/pedidos          - Listar pedidos protegido');
      console.log('   POST /api/pedidos          - Crear pedido protegido');
      console.log('   GET  /api/usuarios         - Listar usuarios protegido');
      console.log('\nPara especificar tenant:');
      console.log('   Header: X-Tenant-ID: 1');
      console.log('   Query: ?tenant_id=1');
      console.log('\nNota: las rutas por tenant requieren X-Tenant-ID o tenant_id');
    });
  } catch (err) {
