/*
  ...
  Modelo Sequelize de Pedidos. Define columnas, tipos y reglas de la tabla que usa el backend.
  Buscar en VS Code: modelo pedidos, tabla pedidos, columnas, tenant_id, Sequelize, relaciones.
